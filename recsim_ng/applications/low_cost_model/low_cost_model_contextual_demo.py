...
def run_simulation(num_runs, num_users, horizon, epsilon):
    ...
    for _ in range(num_runs):
        variables = simulation_config.create_glm_contextual_simulation_network(epsilon= epsilon, num_users=num_users, more_interested_topics = True, freeze_user=False)
