"""Tests for recsim_ng.applications.low_cost_model."""
import os

from absl.testing import parameterized
import numpy as np
from recsim_ng.applications.low_cost_model import low_cost_model
from recsim_ng.applications.low_cost_model import simulation_config
from recsim_ng.applications.low_cost_model import user_dynamic_interest as user
...
class BaselineModelSimulationTest(tf.test.TestCase, parameterized.TestCase):
    ...
    def test_cumulative_reward_run(self):
        mean = low_cost_model.run_simulation(
            1, # num_runs
            1, # num_users
            500, # horizon
            0.3 # epsilon
